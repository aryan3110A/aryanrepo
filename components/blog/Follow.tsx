export default function FollowSection() {
    return (
      <div className="w-full py-20 px-10 bg-blue-100 rounded-lg mb-20">
        <h2 className="text-3xl font-bold text-center text-gray-800 mb-16">Follow txt</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          {[
            ...
            <div key={social.name} className="bg-white p-8 rounded-lg shadow-sm">
              <div className="flex justify-center mb-6">{social.icon}</div>
              <p className="text-gray-700 text-center mb-10">{social.description}</p>
              <div className="flex justify-center">
                <button className="border border-gray-300 rounded-md py-2 px-8 text-gray-700 hover:bg-gray-50">
                  Learn more
                </button>
              </div>
            </div>
        ...
        <div className="mt-10">
          <div className="bg-white p-8 rounded-lg shadow-sm max-w-2xl mx-auto">
            ...
            <div className="flex justify-center">
              <button className="bg-blue-500 text-white rounded-md py-2 px-8 hover:bg-blue-600">
                Subscribe
              </button>
            </div>
          </div>
